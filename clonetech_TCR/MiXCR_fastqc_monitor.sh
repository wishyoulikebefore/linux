...
python=/ehpcdata/sge_software/anaconda3/bin/python
...
PATH=/ehpcdata/sge_software/anaconda3/bin:\$PATH
...
${python} /home/zuotianyu/script/fastqc/fastqc_monitor.py -f ${Result_path}/fastqc/${sample_id}/${sample_id}_combined_R1_fastqc.zip
${python} /home/zuotianyu/script/fastqc/fastqc_monitor.py -f ${Result_path}/fastqc/${sample_id}/${sample_id}_combined_R2_fastqc.zip
if [ \$? != 0 ]; then
    exit 1
fi
